$(function () {
    ...
    //获取店铺列表的URL
    var listUrl = '/gdufo2o/frontend/listshops';

    //获取店铺类别列表以及区域列表的URL
    var searchDivUrl = '/gdufo2o/frontend/listshopspageinfo';

    //页码
    var pageNum = 1;

    //从地址栏URL尝试获取parentId/shopId/categoryId
    ...
    function addItems(pageSize, pageIndex) {
        ...
        $.getJSON(url, function (data) {
            if (data.success) {
                ...
                var html = '';
                //遍历店铺列表，拼接出卡片集合
                //shopListt 后台写错了 还没改 前台要和后台一致
                data.shopListt.map(function(item,index){
    ...
    $('.shop-list').on('click', '.card', function (e) {
        ...
        window.location.href = '/gdufo2o/frontend/shopdetail?shopId=' + shopId;
    });
